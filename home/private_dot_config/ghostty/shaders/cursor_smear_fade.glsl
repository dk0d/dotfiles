...
const float OPACITY = 0.5; // Opacity of the cursor trail
const vec4 TRAIL_COLOR = vec4(.3, .32, .35, 1.); // Color of the cursor trail
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    newColor = mix(newColor, newColor, OPACITY);
