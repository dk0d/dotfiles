...
const vec4 TRAIL_COLOR = vec4(.3, 0.4, 0.761, 1.0); // bluish
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
// const vec4 TRAIL_COLOR_ACCENT = vec4(.82, 0., 0., 0.5); // red-orange
const vec4 TRAIL_COLOR_ACCENT = vec4(.2, 0.4, .7, 0.5); // bluish
