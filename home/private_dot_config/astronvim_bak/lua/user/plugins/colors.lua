...
-- local catppuccin_onedark = {
-- 	rosewater = onedark.darker.purple,
-- 	flamingo = onedark.darker.flamingo,
-- 	pink = onedark.darker.pink,
-- 	mauve = onedark.darker.dark_purple,
-- 	lavender = onedark.darker.dark_red,
-- 	red = onedark.darker.red,
-- 	maroon = onedark.darker.maroon,
-- 	peach = onedark.darker.orange,
-- 	yellow = onedark.darker.yellow,
-- 	green = onedark.darker.green,
-- 	teal = onedark.darker.cyan,
-- 	sky = onedark.darker.blue,
-- 	sapphire = onedark.darker.darker_cyan,
-- 	blue = onedark.darker.bg_blue,
-- 	text = onedark.darker.fg,
-- 	subtext1 = onedark.darker.dimmed1,
-- 	subtext0 = onedark.darker.dimmed2,
-- 	overlay2 = onedark.darker.dimmed3,
-- 	overlay1 = onedark.darker.dimmed4,
-- 	overlay0 = onedark.darker.light_grey,
-- 	surface2 = onedark.darker.bg3,
-- 	surface1 = onedark.darker.bg2,
-- 	surface0 = onedark.darker.bg1,
-- 	base = onedark.darker.bg_d,
-- 	mantle = onedark.darker.bg0,
-- 	crust = onedark.darker.black,
-- }
...
local cat_kan = {
	rosewater = kanagawa.autumnRed,
	flamingo = kanagawa.oldWhite,
	pink = kanagawa.oldWhite,
	mauve = kanagawa.oldWhite,
	red = kanagawa.oldWhite,
	maroon = kanagawa.oldWhite,
	peach = kanagawa.oldWhite,
	yellow = kanagawa.oldWhite,
	green = kanagawa.oldWhite,
	teal = kanagawa.oldWhite,
	sky = kanagawa.oldWhite,
	sapphire = kanagawa.oldWhite,
	blue = kanagawa.oldWhite,
	lavender = kanagawa.oldWhite,
	text = kanagawa.oldWhite,
	subtext1 = kanagawa.oldWhite,
	subtext0 = kanagawa.oldWhite,
	overlay2 = kanagawa.oldWhite,
	overlay1 = kanagawa.sumiInk4,
	overlay0 = kanagawa.sumiInk3,
	surface2 = kanagawa.sumiInk2,
	surface1 = kanagawa.sumiInk4,
	surface0 = kanagawa.sumiInk3,
	base = kanagawa.sumiInk2,
	mantle = kanagawa.sumiInk1,
	crust = kanagawa.sumiInk0,
}
