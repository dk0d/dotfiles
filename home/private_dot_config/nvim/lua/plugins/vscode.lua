  ...
  -- add a few keybindings
  {
    ...
    opts = function(_, opts)
      ...
      maps.n["<Leader>q"] = function()
        require("vscode-neovim").action("workbench.action.closeWindow")
      end
      maps.n["<Leader>w"] = function()
        require("vscode-neovim").action("workbench.action.files.save")
      end
      maps.n["<Leader>n"] = function()
        require("vscode-neovim").action("welcome.showNewFileEntries")
      end
      ...
      maps.n["<Leader>fC"] = function()
        require("vscode-neovim").action("workbench.action.showCommands")
      end
      maps.n["<Leader>ff"] = function()
        require("vscode-neovim").action("workbench.action.quickOpen")
      end
      maps.n["<Leader>fn"] = function()
        require("vscode-neovim").action("notifications.showList")
      end
      maps.n["<Leader>fo"] = function()
        require("vscode-neovim").action("workbench.action.openRecent")
      end
      maps.n["<Leader>ft"] = function()
        require("vscode-neovim").action("workbench.action.selectTheme")
      end
      ...
      -- git client
      maps.n["<Leader>gg"] = function()
        require("vscode-neovim").action("workbench.view.scm")
      end
      ...
      maps.n["<Leader>la"] = function()
        require("vscode-neovim").action("editor.action.quickFix")
      end
      maps.n["<Leader>lG"] = function()
        require("vscode-neovim").action("workbench.action.showAllSymbols")
      end
      maps.n["<Leader>lR"] = function()
        require("vscode-neovim").action("editor.action.goToReferences")
      end
      maps.n["<Leader>lr"] = function()
